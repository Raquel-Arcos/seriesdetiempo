...
```{r pedazo10, fig.align="center", fig.cap="Gráfica_10"}
...
```{r pedazo11, fig.align="center", fig.cap="Gráfica_11"}
#Plot Apple's stock price 
plot(data$apple, type = "l", las=1, main = "Apple stock price", xlab ="date")
```

```{r pedazo12, fig.align="center", fig.cap="Gráfica_12"}
...
```{r pedazo13, fig.align="center", fig.cap="Gráfica_13"}
